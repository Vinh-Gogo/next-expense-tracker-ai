          ...
          <div className='text-center md:text-left'>
            ...
            <div className='space-y-3'>
              <div className='flex items-center gap-3 text-gray-600 dark:text-gray-400 text-sm'>
                <div className='w-5 h-5 bg-linear-to-br from-emerald-500 to-green-500 rounded-md flex items-center justify-center shadow-xs'>
                  <span className='text-white text-xs'>🤖</span>
                </div>
                AI-Powered Insights
              </div>
              <div className='flex items-center gap-3 text-gray-600 dark:text-gray-400 text-sm'>
                <div className='w-5 h-5 bg-linear-to-br from-green-500 to-teal-500 rounded-md flex items-center justify-center shadow-xs'>
                  <span className='text-white text-xs'>✨</span>
                </div>
                Smart Categorization
              </div>
              <div className='flex items-center gap-3 text-gray-600 dark:text-gray-400 text-sm'>
                <div className='w-5 h-5 bg-linear-to-br from-teal-500 to-emerald-500 rounded-md flex items-center justify-center shadow-xs'>
                  <span className='text-white text-xs'>📊</span>
                </div>
                Analytics Dashboard
              </div>
