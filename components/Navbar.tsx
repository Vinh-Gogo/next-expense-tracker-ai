...
export default function Navbar() {
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false); // mặc định ban đầu là đóng
  ...
  return (
    <nav className='sticky top-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-b border-gray-200/50 dark:border-gray-600/50 shadow-lg shadow-gray-900/5 dark:shadow-black/30'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex items-center justify-between h-14 sm:h-16'>
          ...
          <div className='flex items-center space-x-1 sm:space-x-2'>
            ...
            <div className='hidden sm:block'>
              ...
              <SignedIn>
                <div className='p-0.5 sm:p-1 rounded-lg sm:rounded-xl bg-linear-to-r from-emerald-100/50 to-green-100/50 dark:from-emerald-900/20 dark:to-green-900/20 backdrop-blur-xs border border-emerald-200/30 dark:border-emerald-700/30'>
                  <UserButton
                    appearance={{
                      elements: {
                        avatarBox:
        ...
        >
          <div className='px-2 pt-2 pb-3 space-y-1 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xs rounded-xl border border-gray-200/50 dark:border-gray-600/50 mt-2 shadow-lg'>
            ...
            <div className='pt-3 border-t border-gray-200/50 dark:border-gray-600/50'>
              ...
              <SignedIn>
                <div className='flex items-center justify-center p-3 rounded-xl bg-linear-to-r from-emerald-100/50 to-green-100/50 dark:from-emerald-900/20 dark:to-green-900/20 backdrop-blur-xs border border-emerald-200/30 dark:border-emerald-700/30'>
                  <UserButton
                    appearance={{
                      elements: {
                        avatarBox:
